...
public class FragmentShow extends Fragment implements RecyclerViewAdapter.OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.show_fragment, container, false);
        myrecyclerview = v.findViewById(R.id.show_recyclerview);
        myrecyclerview.setHasFixedSize(true);

        myrecyclerview.setLayoutManager(new LinearLayoutManager(getActivity()));
        RecyclerViewAdapter recyclerViewAdapter = new RecyclerViewAdapter(getContext(), films);
        myrecyclerview.setAdapter(recyclerViewAdapter);
        recyclerViewAdapter.setOnItemClickListener(FragmentShow.this);
    ...
    private void prepare() {
        ...
        dataDescription = getResources().getStringArray(R.array.show_description);
